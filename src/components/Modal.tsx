...
const Modal: React.FC<ModalProps> = (props) => {
  ...
  return (
    <>
      <div
        onClick={closeModal}
        className='bg-glassBlue fixed h-screen  w-screen top-0 left-0 opacity-90 z-50'
      ></div>
      <div className='w-[640px] h-[639px] z-[999] bg-contentWhite rounded-xl pt-4 px-4 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2'>
        ...
        <div className='px-12'>
          <p className='text-center text-lg font-BPG-Nino-Mtavruli tracking-wide pb-3 border-b border-black'>
            {props.title}
          </p>
          {props.children}
        </div>
