    ...
    <div className='h-[480px] flex flex-col justify-between'>
      ...
      <div className='flex justify-center'>
        <div className='flex gap-7 w-fit'>
          ...
          <button className='text-lg animate-fade-in text-center w-20 px-5 pb-3 pt-4 hover:transition-transform   hover:scale-105 rounded-md   font-BPG-Nino-Mtavruli font-bold text-white bg-rose-700 border border-gray-900'>
